This API allows Fast Parcel Operators (FPOs), software developers and 3rd party users to check if the holders of provided EORI Numbers have a valid UKIM authorisation.
