...
case class UKIMAuthCheckerResult(eori: Eori, authorised: Boolean)

object UKIMAuthCheckerResult {
  implicit val format: OFormat[UKIMAuthCheckerResult] = Json.format[UKIMAuthCheckerResult]
}